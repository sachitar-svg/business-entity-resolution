...
THRESHOLDS = [
    round(value / 1000, 3)
    for value in range(800, 901, 5)
]


# Candidate file rows can contain very large fields.
...
def entity_f05(
    ...
    # Correctly predicting an empty match set.
    if denominator == 0:
        return 1.0, tp, fp, fn
...
def main():
    ...
    print()
    print("=" * 70)
    print("V2 FINE THRESHOLD RESULTS")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("V2 FINE THRESHOLD SWEEP COMPLETE")
    print("=" * 70)
