...
def main():
    ...
    parser.add_argument(
        "--source1",
        type=str,
        default=str(SOURCE1_PATH),
        help=(
            "Normalized Source-1 Parquet path. "
            "Defaults to the training Source-1 file."
        ),
    )
    ...
    parser.add_argument(
        "--source2",
        type=str,
        default=str(SOURCE2_PATH),
        help=(
            "Normalized Source-2 Parquet path. "
            "Defaults to the training Source-2 file."
        ),
    )
    ...
    parser.add_argument(
        "--source3",
        type=str,
        default=str(SOURCE3_PATH),
        help=(
            "Normalized Source-3 Parquet path. "
            "Defaults to the training Source-3 file."
        ),
    )
