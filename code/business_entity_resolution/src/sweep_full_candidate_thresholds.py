...
RESULT_PATH = (
    PROJECT_ROOT
    / "output"
    / "full_candidate_threshold_results.csv"
)
...
# Candidate files can contain extremely large comma-separated fields.
csv.field_size_limit(sys.maxsize)


# ============================================================
# LOAD COMPLETE CANDIDATE MAP
# ============================================================
...
def load_validation_candidates(
    ...
    """
    Load every candidate ID for validation S1 entities.
    """
    ...
    with open(
        ...
        if len(header) != 2:
            raise ValueError(
                "Candidate file must have exactly two tab-separated columns."
            )
...
def score_all_candidates(
    ...
    Returns:
        probability_map[s1_id] = list of (candidate_id, probability)
    """
...
def evaluate_threshold(
    ...
    """
    Evaluate one threshold across all validation S1 entities.
    """
...
def main():
    ...
    print("=" * 70)
    print("FULL-CANDIDATE THRESHOLD SWEEP")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("BEST FULL-CANDIDATE THRESHOLD")
    print("=" * 70)
